            ...
            <div class="container" style="width: 500px">
                    <form method="POST" action="{{route('article.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          ...
                          @enderror" name="title" id="title" aria-describedby="name" placeholder="Enter Title">
                          @error('title')
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <textarea type="text" class="form-control @error('title') is-invalid
                            @enderror" name="content" id="content" aria-describedby="content" placeholder="Enter content"></textarea>
                            @error('content')
                                <div class="invalid-feedback">
                                      {{$message}}
                                </div>
                          ...
                          <img class="img-preview img-fluid mx-auto d-block mt-3" >
